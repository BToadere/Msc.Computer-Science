...
from src.solver.neighborhood import generate_initial_schedule, generate_laarhoven_neighborhood
...
def calculate_lower_bound(instance: JSSP_DiGraph) -> int:
    ...
    Esta cota se basa en la carga maxima de cualquier maquina.
    """
    # Ninguna solucion puede ser mejor que el tiempo total de trabajo requerido por 
    # la maquina mas ocupada, ya que no hay paralelismo dentro de una maquina.
...
if __name__ == '__main__':
    ...
    best_schedule, best_value = do_tabu_search(instance=js,
                                               ...
                                               neighborhood_func=generate_laarhoven_neighborhood,
    ...
    print(f"-------------------------------------------------")
    print(f"Schedule encontrado: {best_schedule}")
